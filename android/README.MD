...
5. Click **Run** (▶️) - app will install and launch on your phone
...
4. Screen displays:
   ...
   > 💡 **Note:** Both `user_id` and `device_id` are auto-generated as UUIDs on first launch and persisted in SharedPreferences.
...
> 💡 Keep the app **open in foreground** to see Toast messages for E2E tests.
